...
for i=1:crop_num
    for j=1:crop_num
        ...
        if crop_dim == 128
            ...
            crop_data(:,:,:,cnt) = imresize(img_data(start1:start1+crop_dim-1,start2:start2+crop_dim-1,:),[128,128],'bilinear');
        end
        cnt=cnt+1;
    end
end
